    ...
    <div class="max-w-4xl mx-auto px-4 mt-12 mb-16">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 bg-gray-50 border-t border-gray-100">
                <p class="text-gray-600">Watch the video carefully. You can pause, rewind, and re-watch as many times as you need. When you are finished, click "Mark as Complete" to track your progress.</p>
            </div>
        </div>
    </div>
