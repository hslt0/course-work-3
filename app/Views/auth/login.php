        ...
        <div class="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="<?= URLROOT ?>/auth/register" class="font-medium text-green-600 hover:text-green-500 transition-colors">
            ...
            <form class="mt-8 space-y-6" action="<?= URLROOT ?>/auth/login" method="POST">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="password" name="password" type="password" autocomplete="current-password" required value="<?= htmlspecialchars($password, ENT_QUOTES, 'UTF-8') ?>"
